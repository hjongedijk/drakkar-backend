...
export const profileTemplates: Prisma.QualityProfileCreateInput[] = [
  ...
  { name: "TV Standard", allowedQualities: ["720p", "1080p"], cutoffQuality: "1080p", preferredWords: ["proper", "repack"], rejectedWords: ["cam"], requiredWords: [], preferredLanguages: [], requiredLanguages: [] },
  { name: "Movie Standard", allowedQualities: ["1080p"], cutoffQuality: "1080p", preferredWords: ["web-dl"], rejectedWords: ["cam"], requiredWords: [], preferredLanguages: [], requiredLanguages: [] },
  { name: "Movie High Quality", allowedQualities: ["1080p", "2160p"], cutoffQuality: "2160p", preferredWords: ["remux", "hdr", "atmos"], rejectedWords: ["cam"], requiredWords: [], preferredLanguages: [], requiredLanguages: [] }
];

...
import { parseNzbXml, type ParsedNzb } from "../services/nzb/parser.js";
import { storeNzbDocument } from "../services/nzb/store.js";
import { createBlocklistItem, getPolicySettings } from "../services/policyService.js";
import { getSettings } from "../services/settings/settingsStore.js";
import { fetchNzbUrl } from "../services/usenet/nzbUrlFetch.js";
import { makeMountedDownloadAvailable } from "../services/importService.js";
import { humanizeDownloadError, statusLabelForDownload } from "../services/downloads/presentation.js";
...
export async function storeNzbForDownload(input: {
  ...
  if (policies.failNzbWithoutVideo && !hasPotentialVideoPayload(parsed)) {
    ...
    await safeUpdateDownload(input.downloadId, { status: "failed", error: reason, size: parsed.totalSize });
